...
3.  Create (or update) the `pubspec.yaml` file and add `dart_chassis_forge` under `dev_dependencies`
...
2.  Run `dart run chassis_forge:kindle` to bootstrap your setup
...
2.  Modify you commands within the specified directory (defaults to `forge`)
